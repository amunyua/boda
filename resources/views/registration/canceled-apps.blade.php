@extends('layouts.dt')
@section('title', 'Canceled Applications')
@section('widget-title', 'Canceled Applications')
@section('table-title', 'Canceled Applications')
...
@section('content')
    <table id="canceled-apps" class="table table-bordered">
        <thead>
        <tr>
