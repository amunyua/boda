...
@section('content')
    <div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
            <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> Dashboard <span>> Analytics Dashboard</span></h1>
        </div>
                ...
                <div class="jarviswidget" id="wid-id-0" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
                    ...
                    <header>
                        ...
                        <ul class="nav nav-tabs pull-right in" id="myTab">
                            <li class="active">
                                <a data-toggle="tab" href="#s1"><i class="fa fa-money"></i> <span class="hidden-mobile hidden-tablet"> Daily Collection</span></a>
                            </li>

                            <li>
                                <a data-toggle="tab" href="#s2"><i class="fa fa-money"></i> <span class="hidden-mobile hidden-tablet"> Weekly Collection</span></a>
                            </li>

                            <li>
                                <a data-toggle="tab" href="#s3"><i class="fa fa-money"></i> <span class="hidden-mobile hidden-tablet"> Monthly Collection</span></a>
                            </li>
                        </ul>
