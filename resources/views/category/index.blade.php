...
@section('widget-title', '<i class="fa fa-list fa-fw "></i> Manage Categories')
@section('widget-desc', 'Manage categories and subcategories')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    ...
                    <form id="add-menu-form" class="smart-form" action="{{ url('add-category') }}" method="post">
                        {{ csrf_field() }}
                        <fieldset>
                            <section>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-10">
                                        <label class="input"> <i class="icon-append fa fa-keyboard-o"></i>
                                            <select name="parent_category" class="live_search" style="width: 100%;">
                                                <option value="1">--Choose Parent category--</option>
                                                <option value="Null">Null</option>
                                                @if(count($parent_categories))
                                                @foreach($parent_categories as $menu)
                                                <?php
