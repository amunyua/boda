...
@section('button')
    ...
    <a href="#edit-inventory" id="edit-edit-bike-btn" class="btn btn-warning btn-sm header-btn hidden-mobile">
                        ...
                        <fieldset>
                            <section>
                                <div class="row">
                                    ...
                                    <div class="col col-10">
                                        <label class="input">
                                            <select name="model" class="form-control select2" id="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-10">
                                        <label class="input"> <i class="icon-append fa fa-keyboard-o"></i>
                                            <input type="text" name="vin" autocomplete="off"  value="{{ old('vin') }}">
                                        </label>
                                    </div>
                                </div>
                            </section>
                            <section>
                                <div class="row">
                                    ...
                                    <div class="col col-10">
                                        <label class="input"> <i class="icon-append fa fa-keyboard-o"></i>
                                            <input type="text" name="chassis_number" autocomplete="off"  value="{{ old('chassis_number') }}">
                                        </label>
                                    </div>
                                </div>
                            </section>
